...
export * from './lib/pipes/o2a/o2a.module';
export * from './lib/pipes/o1i/o1i.pipe';
export * from './lib/pipes/o1i/o1i.module';
...
export * from './lib/pipes/currencyx/currencyx.module';
export * from './lib/pipes/datex/datex.pipe';
export * from './lib/pipes/datex/datex.module';
export * from './lib/pipes/ago/ago.pipe';
export * from './lib/pipes/ago/ago.module';
export * from './lib/pipes/list/list.pipe';
export * from './lib/pipes/list/list.module';
